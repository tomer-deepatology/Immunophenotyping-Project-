...
# Paths
im_path = r"C:\Users\perez\Desktop\deepatplogy_very_temp\data\project 1\sample 2\225_panCK CD8_TRSPZ012209_u673_2_40X.tif"
...
plt.savefig('cropped_with_annotations.tif', dpi=300, bbox_inches='tight', pad_inches=0)
plt.close()
